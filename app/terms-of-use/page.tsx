...
export default function TermsPage() {
  return (
    <div className="container-page py-14 max-w-3xl">
      ...
      <h1 className="font-sans tracking-tight text-3xl font-semibold text-ink mb-6">Terms of Use</h1>
      <div className="text-ink-soft space-y-4 text-sm leading-relaxed">
        ...
        <h2 className="font-sans tracking-tight text-xl font-semibold text-ink pt-4">Not an Online Store</h2>
        <p>
        ...
        <h2 className="font-sans tracking-tight text-xl font-semibold text-ink pt-4">Product Information</h2>
        <p>
          ...
          <a href="/product-disclaimer" className="text-ink hover:text-accent">Product Disclaimer</a>{" "}
          for further detail.
        </p>
