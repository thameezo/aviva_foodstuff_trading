...
export default function PrivacyPolicyPage() {
  return (
    <div className="container-page py-14 max-w-3xl">
      ...
      <h1 className="font-serif text-3xl font-semibold text-ink mb-6">Privacy Policy</h1>
      <div className="prose-sm text-ink-soft space-y-4 text-sm leading-relaxed">
        ...
        <h2 className="font-serif text-xl font-semibold text-ink pt-4">Information We Collect</h2>
        <p>
        ...
        <h2 className="font-serif text-xl font-semibold text-ink pt-4">How We Use It</h2>
        <p>
